...
export default function DashboardLayout({ title, children }) {
  ...
  const navigation = [
    ...
    { name: "Create Post", href: route("posts.create"), icon: PlusCircle, current: route().current("posts.create") },
    { name: "Settings", href: route("settings"), icon: Settings, current: route().current("settings") },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={`fixed inset-0 z-40 lg:hidden ${sidebarOpen ? "block" : "hidden"}`}>
        {/* Sidebar overlay */}
        <div className="fixed inset-0 bg-muted/80" onClick={() => setSidebarOpen(false)}></div>
